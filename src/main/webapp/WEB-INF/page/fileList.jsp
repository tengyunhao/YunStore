...
<div class="layui-row">
	<div class="layui-col-xs12 layui-col-sm12 layui-col-md12" style="margin: 8px 3px;">
        <a style="margin-right:18px" id="0" href="#">全部文件</a>
...
<script>
var reloadTable,directoryEnter,directoryBack;
layui.use(['table','element'], function() {
	...
	var parentName = "";
    url = url.substring(0,url.indexOf("#"))+"#file/list.do";
        ...
        $.post("${pageContext.request.contextPath }/get-directory.do",{
            ...
            for(var i = result.data.length-1; i >= 0; i--) {
                ...
                if(i == 0) {
                    ...
                    $("#path").append("<a href='#file/list.do#"+line.id+"' onclick='directoryBack(\""+line.id+"\",\""+line.name+"\")' class='path'>"+line.name+"<span class='layui-box'>&gt;</span></a>");
                }
            }
